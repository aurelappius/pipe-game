...
background.x = display.contentCenterX-0.5*display.contentWidth
background.y = display.contentCenterY-0.5*display.contentHeight

local board_background = display.newImageRect(tileGroup, "img/board_background.png", 1280, 720)
board_background.x = display.contentCenterX-0.5*display.contentWidth
board_background.y = display.contentCenterY-0.5*display.contentHeight

local sheetOptions_A =
{
  frames=
  {
    {x=55 ,y=0,width=104,height=104},--horizontal grey
    {x=183,y=0,width=104,height=104},--vertikal grey
    {x=311,y=0,width=104,height=104},--up right grey
    {x=461,y=0,width=104,height=104},--down right grey
    {x=624,y=0,width=104,height=104},--down left grey
    {x=775,y=0,width=104,height=104}, --up left grey
    {x=55 ,y=127,width=104,height=104},--horizontal blue
    {x=183,y=127,width=104,height=104},--vertikal blue
    {x=311,y=127,width=104,height=104},--up right blue
    {x=461,y=127,width=104,height=104},--down right blue
    {x=624,y=127,width=104,height=104},--down left blue
    {x=775,y=127,width=104,height=104}, --up left blue
    {x=55 ,y=254,width=104,height=104},--horizontal red
    {x=183,y=254,width=104,height=104},--vertikal red
    {x=311,y=254,width=104,height=104},--up right red
    {x=461,y=254,width=104,height=104},--down right red
    {x=624,y=254,width=104,height=104},--down left red
    {x=775,y=254,width=104,height=104}, --up left red
    {x=55 ,y=381,width=104,height=104},--horizontal yellow
    {x=183,y=381,width=104,height=104},--vertikal yellow
    {x=311,y=381,width=104,height=104},--up right yellow
    {x=461,y=381,width=104,height=104},--down right yellow
    {x=624,y=381,width=104,height=104},--down left yellow
    {x=775,y=381,width=104,height=104}, --up left yellow
    {x=1590,y=0,width=104,height=104}, --empty
    {x=1590,y=104,width=104,height=104} --stone
  }
}
local sheetOptions_B=
{
  frames=
  {
    {x=944 ,y=0,width=104,height=104},-- grey - grey
    {x=1114,y=0,width=104,height=104},-- grey - blue
    {x=1283,y=0,width=104,height=104},-- grey - red
    {x=1452,y=0,width=104,height=104},-- grey - yellow
    {x=944 ,y=127,width=104,height=104},-- blue - grey
    {x=1114,y=127,width=104,height=104},-- blue - blue
    {x=1283,y=127,width=104,height=104},-- blue - red
    {x=1452,y=127,width=104,height=104},-- blue - yellow
    {x=944 ,y=254,width=104,height=104},-- red - grey
    {x=1114,y=254,width=104,height=104},-- red - blue
    {x=1283,y=254,width=104,height=104},-- red - red
    {x=1452,y=254,width=104,height=104},-- red - yellow
    {x=944 ,y=381,width=104,height=104},-- yellow - grey
    {x=1114,y=381,width=104,height=104},-- yellow - blue
    {x=1283,y=381,width=104,height=104},-- yellow - yellow
    {x=1452,y=381,width=104,height=104},-- yellow - red
  }
}
...
printTab = function()
  print("PRINT A:")
  for i=1,6 do
    print(whereFromA[i][1].."   "..whereFromA[i][2].."   "..whereFromA[i][3].."   "..whereFromA[i][4].."   "..whereFromA[i][5].."   "..whereFromA[i][6].."   "..whereFromA[i][7].."   "..whereFromA[i][8])
  end
  print("PRINT B:")
  for i=1,6 do
    print(whereFromB[i][1].."   "..whereFromB[i][2].."   "..whereFromB[i][3].."   "..whereFromB[i][4].."   "..whereFromB[i][5].."   "..whereFromB[i][6].."   "..whereFromB[i][7].."   "..whereFromB[i][8])
  end
end
...
tileEvent = function(event)
  if(pauseActive==false)then
    ...
    if(buttonPressed==1 and board[row][col]~=9) then
    ...
    elseif(buttonPressed==2 and board[row][col]~=9) then
    ...
    elseif(buttonPressed==3 and board[row][col]~=7 and N[3]>0  and board[row][col]~=9) then --create new tile
      if(board[row][col]==1 or board[row][col]==2)then N[1]=N[1]+1 end
      if(board[row][col]>=3 and board[row][col]<=6)then N[2]=N[2]+1 end
      board[row][col]=7
      N[3]=N[3]-1
    elseif(buttonPressed==4 and board[row][col]==9 and N[4]>0) then
      --animation
      ...
      board[row][col]=8
      N[4]=N[4]-1
    elseif(buttonPressed==5 and board[row][col]~=9) then
      if(board[row][col]==1 or board[row][col]==2) then N[1]=N[1]+1 end
      if(board[row][col]>=3 and board[row][col]<=6) then N[2]=N[2]+1 end
      if(board[row][col]==7) then N[3]=N[3]+1 end
      board[row][col]=8
...
pause=function()
  pauseActive=true
  local pauseScreen = display.newImageRect(pauseGroup, "img/pauseScreen.png", 1280, 720)
  pauseScreen.x = display.contentCenterX-0.5*display.contentWidth
  pauseScreen.y = display.contentCenterY-0.5*display.contentHeight
  ...
  button[10].y=420
  button[10]:addEventListener("tap",quitEvent)
end

endofgame=function()
  pauseActive=true
  local successScreen = display.newImageRect(pauseGroup, "img/successScreen.png", 1280, 720)
  successScreen.x = 0
  successScreen.y = 0
  ...
  button[11].y=290
  button[11]:addEventListener("touch",nextLevel)
  ...
  button[13].y=490
  button[13]:addEventListener("tap",quitEvent)
